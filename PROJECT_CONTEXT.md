...
- The Windows build helper validates the Desktop app credentials shape, runs `flutter clean`, and builds with direct `--dart-define` to avoid missing or stale credential defines.
